...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('lang.PARTY_LEDGER') for {{$userName->name ??''}}</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                        ...
                        <table class="table table-bordered bg-light" >
                            <thead>
                                <tr>
                                    ...
                                    <td> <label>@lang('lang.D_BALANCE')</label></td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
    ...
    <section class="content">
        <div class="container-fluid">
            {!!Form::open(['route'=>'serviceContract.detailsFilter','method'=>'GET'])!!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="float-right mt-2" style="margin-left: 45%;">
                                        ...
                                        ?>
                                        <a class="btn btn-warning text-right" href="{{url('admin/party-ledger-list/'.$user_id.'/details?'.$url.'&print=true')}}"><i class="fa fa-print"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
