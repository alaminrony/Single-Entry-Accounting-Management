...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('lang.REPORT') for {{$supplierName->name ??''}}</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            {!!Form::open(['route'=>'payable.detailsFilter','method'=>'GET'])!!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="float-right mt-2" style="margin-left: 45%;">
                                        ...
                                        ?>
                                        <a class="btn btn-warning text-right" href="{{url('admin/account-payable/'.$supplier_id.'/details?'.$url.'&print=true')}}"><i class="fa fa-print"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
