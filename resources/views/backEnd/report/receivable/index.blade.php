...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('lang.REPORT_RECEIVABLE')</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                <label>@lang('lang.CUSTOMER'):</label>
                                {!!Form::select('customer_id',$customers,Request::get('supplier_id'),['class'=>'select2 form-control','id'=>'trType','width'=>'100%']) !!}
