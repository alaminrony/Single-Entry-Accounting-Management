<div class="modal-content">
    <div class="modal-header clone-modal-header bg-secondary">
        <h4 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus-square"></i> {!!__('lang.CREATE_TRANSACTION')!!}</h4>
    </div>
    <div class="modal-body">
        {!!Form::open(['id'=>'saveFormData','class'=>'form-horizontal'])!!}
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    {!!Form::text('passport','',['class'=>'form-control','id'=>'passport'])!!}
            ...
            <div style="display: none;" id='reIssueField'>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        {!!Form::text('old_ticket_no',$OldTicketNo,['class'=>'form-control','id'=>'old_ticket_no','readonly'])!!}
                ...
                <div class="form-group row" >
                    ...
                    <div class="col-sm-8">
                        {!!Form::text('new_ticket_no',old('new_ticket_no'),['class'=>'form-control','id'=>'new_ticket_no'])!!}
            ...
            <div style="display: none;" id='deportField'>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group date" id="first_issue_date" data-target-input="nearest">
                            <input type="text" name='first_issue_date' class="form-control datetimepicker-input" data-target="#first_issue_date" value="{{old('first_issue_date')}}" placeholder="yyyy/mm/dd"/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group date" id="fly_date" data-target-input="nearest">
                            <input type="text" name='fly_date' class="form-control datetimepicker-input" data-target="#fly_date" value="{{old('fly_date')}}" placeholder="yyyy/mm/dd"/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group date" id="return_date" data-target-input="nearest">
                            <input type="text" name='return_date' class="form-control datetimepicker-input" data-target="#return_date" value="{{old('return_date')}}" placeholder="yyyy/mm/dd"/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        {!!Form::text('flied_to',old('flied_to'),['class'=>'form-control','id'=>'flied_to'])!!}
                ...
                <div class="form-group row" >
                    ...
                    <div class="col-sm-8">
                        {!!Form::text('ticket_no',old('ticket_no'),['class'=>'form-control','id'=>'ticket_no'])!!}
                ...
                <div class="form-group row" >
                    ...
                    <div class="col-sm-8">
                        {!!Form::text('deport_ticket_no',old('deport_ticket_no'),['class'=>'form-control','id'=>'deport_ticket_no'])!!}
                ...
                <div class="form-group row" >
                    ...
                    <div class="col-sm-8">
                        {!!Form::text('fare',old('fare'),['class'=>'form-control','id'=>'fare'])!!}
            ...
            <div style="display: none;" id='refundIssueField'>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        {!!Form::text('refund_charge','',['class'=>'form-control','id'=>'refund_charge'])!!}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    {!!Form::text('num_of_package',1,['class'=>'form-control','id'=>'numOfPackage'])!!}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    {!!Form::select('payment_mode',$paymentMode,'',['class'=>'form-control','id'=>'paymentMode','data-width'=>'100%']) !!}
            ...
            <div class="form-group row"  style="display: none;" id="bankAccount">
                ...
                <div class="col-sm-8">
                    {!!Form::select('bank_account_id',$bankAccountArr,!empty(old('bank_account_id')) ? old('bank_account_id') : null,['class'=>'form-control select2','data-width'=>'100%']) !!}
            ...
            <div class="form-group row"  style="display: none;" id="chequeNo">
                ...
                <div class="col-sm-8">
                    {!!Form::text('cheque_no','',['class'=>'form-control','id'=>'checkNumber','data-width'=>'100%'])!!}
    ...
    <div class="modal-footer">
        <fieldset class="w-100">
            ...
            <button type="button" id="save" class="btn btn-secondary float-right" >Save</button>
        </fieldset>
    </div>
    {!!Form::close()!!}
</div>
