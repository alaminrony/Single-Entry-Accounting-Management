                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('lang.VOUCHER_EDIT')</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        {!!Form::open(['route'=>['transaction.update',$target->id],'class'=>'form-horizontal'])!!}
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!!Form::select('transaction_type',$transactionTypeArr,!empty($target->transaction_type) ? $target->transaction_type : null,['class'=>'form-control','id'=>'trType']) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!!Form::select('issue_id',$issueArr,!empty($target->issue_id) ? $target->issue_id : null,['class'=>'form-control','id'=>'Issue']) !!}
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        {!!Form::select('user_id',$users,!empty($target->user_id) ? $target->user_id : null,['class'=>'form-control','id'=>'user_id','class'=>'js-example-basic-single','data-width'=>'100%']) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!!Form::select('payment_mode',$paymentModeArr,!empty($target->payment_mode) ? $target->payment_mode : null,['class'=>'form-control','id'=>'paymentMode']) !!}
                            ...
                            <div class="form-group row" style="display: none;" id="bankAccount">
                                ...
                                <div class="col-sm-9">
                                    {!!Form::select('bank_account_id',$bankAccountArr,!empty($target->bank_account_id) ? $target->bank_account_id : null,['class'=>'form-control']) !!}
                            ...
                            <div class="form-group row" style="display: none;" id="chequeNo">
                                ...
                                <div class="col-sm-9">
                                    {!!Form::text('cheque_no',$target->cheque_no,['class'=>'form-control','id'=>'checkNumber','placeholder'=>'Enter cheque no'])!!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!!Form::number('amount',$target->amount,['class'=>'form-control','id'=>'Amount','placeholder'=>'Enter amount'])!!}
