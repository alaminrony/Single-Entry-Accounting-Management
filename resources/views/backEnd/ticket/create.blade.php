                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('lang.CREATE_TICKET')</h3>
                        ...
                        {!!Form::open(['route'=>'ticketEntry.store','class'=>'form-horizontal','enctype'=>'multipart/form-data'])!!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!!Form::text('ticket_no',old('ticket_no'),['class'=>'form-control','id'=>'ticket_no','placeholder'=>"Enter ticket no"])!!}
