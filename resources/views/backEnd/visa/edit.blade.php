                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!!Form::text('police_reference_no',!empty($target->police_reference_no) ? $target->police_reference_no : old('police_reference_no'),['class'=>'form-control','id'=>'police_reference_no','placeholder'=>"Enter police reference no"])!!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date"  data-target-input="nearest">
                                            {!!Form::select('ref_agent',$users,!empty($target->ref_agent) ? $target->ref_agent : old('ref_agent'),['class'=>'form-control select2','id'=>'User','data-width'=>'80%']) !!}
